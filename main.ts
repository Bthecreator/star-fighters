...
controller.player2.onButtonEvent(ControllerButton.A, ControllerButtonEvent.Repeated, function on_player2_button_a_repeated() {
...
sprites.onOverlap(SpriteKind.projectile2, SpriteKind.Enemy, function on_on_overlap(sprite: Sprite, otherSprite: Sprite) {
    pause(100)
